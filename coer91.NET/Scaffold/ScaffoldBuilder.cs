        ...
        protected void CreateIRepository()
        {
            if (Directory.Exists(_repositoryInterfaceOutput))
            {
                ...
                if (path is not null)
                {
                    ...
                    streamWriter.WriteLine($"using Repository.{_project}.Database;");
                    streamWriter.WriteLine($"using System.Linq.Expressions;");
                    streamWriter.WriteLine();
                    streamWriter.WriteLine($"namespace Repository.{_project}.Interfaces");
                    streamWriter.WriteLine($"{{");
        ...
        protected void CreateRepository()
        {
            if (Directory.Exists(_repositoryOutput))
            {
                ...
                if (path is not null)
                {
                    ...
                    streamWriter.WriteLine($"using Repository.{_project}.Interfaces;");
                    streamWriter.WriteLine($"using Repository.{_project}.Database;");
                    streamWriter.WriteLine($"using System.Linq.Expressions;");
                    streamWriter.WriteLine();
                    streamWriter.WriteLine($"namespace Repository.{_project}.Repositories");
                    streamWriter.WriteLine("{");
                    streamWriter.WriteLine($"\tpublic class {_class}Repository(Context _context) : I{_class}Repository");
                    streamWriter.WriteLine($"\t{{");
                    streamWriter.WriteLine();
                ...
                try
                {
                    if (collection.Equals(BUILD.Tests))
                    {
                        ...
                        if (File.Exists(path))
                        {
                            ...
                            if (!dictionary.Any(x => x.Value.Trim().Contains($"class Xunit{_class} : Xunit{_project}Tests")))
                            {
                                ...
                                dictionary.Add(++keyRepository, $"\tpublic abstract class Xunit{_class} : Xunit{_project}Tests");
                                dictionary.Add(++keyRepository, $"\t{{");
